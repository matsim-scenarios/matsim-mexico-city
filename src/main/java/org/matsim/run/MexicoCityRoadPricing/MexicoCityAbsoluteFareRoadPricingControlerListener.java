 ...
 * @author mrieser
 */
class MexicoCityAbsoluteFareRoadPricingControlerListener implements StartupListener, IterationEndsListener, ShutdownListener {

	final Logger log = LogManager.getLogger(MexicoCityAbsoluteFareRoadPricingControlerListener.class);

	private final RoadPricingScheme scheme;
	private final MexicoCityAbsoluteFareRoadPricingTollCalculator calcPaidToll;
	private final CalcAverageTolledTripLength cattl;
	private final OutputDirectoryHierarchy controlerIO;

	@Inject
	MexicoCityAbsoluteFareRoadPricingControlerListener(RoadPricingScheme scheme, Network network,
													   EventsManager events, OutputDirectoryHierarchy controlerIO, Population population ) {
		this.scheme = scheme;
		this.calcPaidToll = new MexicoCityAbsoluteFareRoadPricingTollCalculator( network, scheme, events, population );
