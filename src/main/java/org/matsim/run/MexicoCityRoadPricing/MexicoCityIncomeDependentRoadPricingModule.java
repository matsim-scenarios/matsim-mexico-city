 ...
 */
public final class MexicoCityIncomeDependentRoadPricingModule extends AbstractModule {
	final Logger log = LogManager.getLogger(MexicoCityIncomeDependentRoadPricingModule.class);

	private RoadPricingScheme scheme;

	public MexicoCityIncomeDependentRoadPricingModule() {}
	...
	public MexicoCityIncomeDependentRoadPricingModule(RoadPricingScheme scheme ) {
		this.scheme = scheme;
	}
	...
	public void install() {
		...
		log.warn("Installing scenario specific module {}. Make sure, this is what you want!", MexicoCityIncomeDependentRoadPricingModule.class.getName());
...
//		// yyyy TODO could probably combine them somewhat
		...
		addControlerListenerBinding().to(MexicoCityIncomeDependentRoadPricingControlerListener.class);
