...
final class CalcAverageTolledTripLength implements LinkEnterEventHandler, PersonArrivalEventHandler, VehicleEntersTrafficEventHandler, VehicleLeavesTrafficEventHandler {
	...
	private final NavigableMap<Id<Person>, Double> agentDistance;

	private final Vehicle2DriverEventHandler delegate = new Vehicle2DriverEventHandler();

	private static final Double ZERO = 0.0;

	CalcAverageTolledTripLength(final Network network, final RoadPricingScheme scheme, EventsManager events) {
		this.scheme = scheme;
