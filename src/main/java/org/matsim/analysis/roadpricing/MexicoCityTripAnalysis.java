...
import org.matsim.dashboard.AdvancedRoadPricingDashboard;
...
public class MexicoCityTripAnalysis implements MATSimAppCommand {
	...
	private static final Logger log = LogManager.getLogger(MexicoCityTripAnalysis.class);

	@CommandLine.Mixin
	private InputOptions input = InputOptions.ofCommand(MexicoCityTripAnalysis.class);
	@CommandLine.Mixin
	private OutputOptions output = OutputOptions.ofCommand(MexicoCityTripAnalysis.class);
	...
	public static void main(String[] args) {
		new MexicoCityTripAnalysis().execute(args);
	}
...
//		trip filter with start OR end
		...
		MexicoCityUtils.addDashboardToExistingRunOutput(new AdvancedRoadPricingDashboard(analysisDir + "\\"),
			runDir);
