...
public final class PlanAssignmentProblem implements Iterable<PlanPerson> {
	...
	final int[] counts;
	final RunCountOptimization.ErrorMetric metric;
	...
	public PlanAssignmentProblem(int maxK, RunCountOptimization.ErrorMetric metric, List<PlanPerson> persons, int[] counts) {
		this.maxK = maxK;
		this.metric = metric;
	...
	private PlanAssignmentProblem(int maxK, RunCountOptimization.ErrorMetric metric, List<PlanPerson> persons, int[] counts, SimpleBigDecimalScore score) {
		this.maxK = maxK;
		this.metric = metric;
		this.persons = persons;
		this.counts = counts;
